<?php
/**
 * nirmalraj Customizer functionality
 *
 * @package WordPress
...
function twentysixteen_custom_header_and_background() {
	...
	/**
	 * Filter the arguments used when adding 'custom-background' support in nirmalraj.
	 *
	 * @since nirmalraj 1.0
	 *
	 * @param array $args {
	...
	/**
	 * Filter the arguments used when adding 'custom-header' support in nirmalraj.
	 *
	 * @since nirmalraj 1.0
	 *
	 * @param array $args {
...
/**
 * Registers color schemes for nirmalraj.
 *
...
function twentysixteen_get_color_schemes() {
	/**
	 * Filter the color schemes registered for use with nirmalraj.
	 *
...
/**
 * Retrieves the current nirmalraj color scheme.
 *
...
/**
 * Retrieves an array of color scheme choices registered for nirmalraj.
 *
...
/**
 * Handles sanitization for nirmalraj color schemes.
 *
